...
async def tigerjoke(ctx):
	...
	oe=discord.Embed(title='Tiger Thangadurai',color=0x57F287,description='Warning ! Palaya Joke\nJokes from general , as well as KPY Champions',url='https://www.hotstar.com/in/tv/kpy-champions/14465')
